...
// Entry rule entryRuleIntitialState
entryRuleIntitialState returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getIntitialStateRule()); }
	iv_ruleIntitialState=ruleIntitialState
	{ $current=$iv_ruleIntitialState.current; }
	EOF;

// Rule IntitialState
ruleIntitialState returns [EObject current=null]
@init {
	enterRule();
}
@after {
