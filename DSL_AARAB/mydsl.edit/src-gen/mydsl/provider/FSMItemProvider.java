...
/**
 * This is the item provider adapter for a {@link mydsl.FSM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FSMItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						MydslPackage.Literals.FSM__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MydslPackage.Literals.FSM__STATE);
			childrenFeatures.add(MydslPackage.Literals.FSM__TRANSITION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(MydslPackage.Literals.FSM__STATE, MydslFactory.eINSTANCE.createState()));

		newChildDescriptors.add(
				createChildParameter(MydslPackage.Literals.FSM__STATE, MydslFactory.eINSTANCE.createIntitialState()));

		newChildDescriptors
				.add(createChildParameter(MydslPackage.Literals.FSM__STATE, MydslFactory.eINSTANCE.createFinalState()));

		newChildDescriptors.add(
				createChildParameter(MydslPackage.Literals.FSM__TRANSITION, MydslFactory.eINSTANCE.createTransition()));
	}
